...
| 版本号      | 构建编号 | 发布日期      |   简要说明   |
| ----------- | ----------- | ----------- | ----------- |
| v0.1.10     | 1829 | 2021.01.18 | 简化版指令集，k8s start可用，开源项目gin-vue-admin适配       |
| [v0.1.9](/zh/blog/2022-0104-sprint9/)          | 1753 | 2021.01.01 | 稳定性和体验性加强，k8s Start, Image V2 体系开发，JetBrain体系WebIDE支持       |
