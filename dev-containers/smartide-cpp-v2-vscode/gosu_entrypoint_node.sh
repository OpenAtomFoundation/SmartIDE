...
###
 ...
 # @FilePath: /smartide/dev-containers/smartide-cpp-v2-vscode/gosu_entrypoint_node.sh
 # @Description: 
 # 
...
if [ $USER_UID == '0' ]; then
    ...
    echo "-----------Starting smartide-cpp-v2-vscode"
    ...
    echo "-----smartide-----Starting gosu smartide-cpp-v2-vscode"
