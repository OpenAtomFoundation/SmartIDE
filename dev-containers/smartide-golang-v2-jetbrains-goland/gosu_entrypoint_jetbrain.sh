...
###
 ...
 # @LastEditors: kenan
 # @LastEditTime: 2022-05-24 15:12:57
 # @FilePath: /smartide/dev-containers/smartide-golang-v2-jetbrains-goland/gosu_entrypoint_jetbrain.sh
 # @Description: 
 # 
...
if [ $USER_UID == '0' ]; then
    ...
    echo "-----smartide-----Starting gosu jetbrains-goland"
